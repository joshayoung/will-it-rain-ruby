    ...
    {"@context"=>
       ...
       "geometry"=>
        {"type"=>"GeometryCollection",
         "geometries"=>
          [{"type"=>"Point", "coordinates"=>[-96.8032707, 32.7796808]},
           {"type"=>"Polygon",
            "coordinates"=>
             [[[-96.8169041, 32.790843], [-96.81654350000001, 32.768216200000005], [-96.78964, 32.7685169], [-96.7899953, 32.791144], [-96.8169041, 32.790843]]]}]},
       "properties"=>
        {"updated"=>"2019-06-01T20:04:52+00:00",
         ...
         "elevation"=>{"value"=>136.8552, "unitCode"=>"unit:m"},
         "periods"=>
          [{"number"=>1,
            "name"=>"Tonight",
            ...
            "detailedForecast"=>
             "A chance of showers and thunderstorms before 1am. Partly cloudy. Low around 74, with temperatures rising to around 76 overnight. Southeast wind around 5 mph. Chance of precipitation is 30%."},
           {"number"=>2,
            "name"=>"Sunday",
            ...
            "shortForecast"=>"Chance Showers And Thunderstorms",
            "detailedForecast"=>
             "A chance of showers and thunderstorms after 7am. Mostly cloudy, with a high near 89. Southeast wind 5 to 10 mph. Chance of precipitation is 50%. New rainfall amounts between a tenth and quarter of an inch possible."},
           {"number"=>3,
            "name"=>"Sunday Night",
            ...
            "shortForecast"=>"Chance Showers And Thunderstorms",
            "detailedForecast"=>
             "A chance of showers and thunderstorms. Mostly cloudy, with a low around 74. Southeast wind 5 to 10 mph. Chance of precipitation is 40%. New rainfall amounts less than a tenth of an inch possible."},
           {"number"=>4,
            "name"=>"Monday",
            ...
            "detailedForecast"=>
             "A slight chance of showers and thunderstorms. Partly sunny, with a high near 91. South southeast wind 5 to 10 mph. Chance of precipitation is 20%."},
           {"number"=>5,
            "name"=>"Monday Night",
            ...
            "shortForecast"=>"Slight Chance Showers And Thunderstorms",
            "detailedForecast"=>
             "A slight chance of showers and thunderstorms. Mostly cloudy, with a low around 74. South southeast wind 5 to 10 mph. Chance of precipitation is 20%."},
           {"number"=>6,
            "name"=>"#{tuesday}",
            ...
            "shortForecast"=>"Chance Showers And Thunderstorms",
            "detailedForecast"=>
             "A chance of showers and thunderstorms. Mostly sunny, with a high near 90. South wind 5 to 10 mph. Chance of precipitation is 30%."},
           {"number"=>7,
            "name"=>"Tuesday Night",
            ...
            "shortForecast"=>"Chance Showers And Thunderstorms",
            "detailedForecast"=>
             "A chance of showers and thunderstorms. Mostly cloudy, with a low around 73. South wind around 10 mph. Chance of precipitation is 50%."},
           {"number"=>8,
            "name"=>"Wednesday",
